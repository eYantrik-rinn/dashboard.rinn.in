                ...
                <div class="flex items-center ms-3">
                    <div>
                        ...
                        >
                            ...
                            <p>
                                User-ID: {$page.data.user.id.substring(0, 5)}<i
...
>
    <div
        class="bg-gradient-to-b from-[#ebf4f5] to-[#b5c6e0] h-full px-3 pt-10 pb-4 overflow-y-auto bg-white dark:bg-gray-800"
    >
        ...
        <ul class="menu_items">
            ...
            <li class="nav_link submenu_item">
                <a href="/appliedLoans" class="nav_link">
                    ...
                    <span class="navlink">Loan Request</span>
                </a>
            </li>
            <!-- End -->
        ...
        <ul class="menu_items">
            <div class="menu_title menu_controller"></div>
            <!-- duplicate these li tag if you want to add or remove navlink only -->
            <!-- Start -->
            <li class="nav_link submenu_item">
                <a href="/appliedLoans" class="nav_link">
                    ...
                    <span class="navlink"> All Controller</span>
                </a>
            </li>
            <!-- End -->
            ...
            <li class="nav_link submenu_item">
                <a href="/loanStatus" class="nav_link">
                    ...
                    <span class="navlink">Controller Status</span>
                </a>
            </li>
            <li class="nav_link submenu_item">
                <a href="/newLoan" class="nav_link">
                    ...
                    <span class="navlink">Add Controller</span>
                </a>
            </li>
        </ul>
        <ul class="menu_items">
            <div class="menu_title menu_broker"></div>
            <!-- duplicate these li tag if you want to add or remove navlink only -->
            <!-- Start -->
            <li class="nav_link submenu_item">
                <a href="/appliedLoans" class="nav_link">
                    ...
                    <span class="navlink"> All Broker</span>
                </a>
            </li>
            <!-- End -->
            ...
            <li class="nav_link submenu_item">
                <a href="/loanStatus" class="nav_link">
                    ...
                    <span class="navlink">Broker Status</span>
                </a>
            </li>
            <li class="nav_link submenu_item">
                <a href="/newLoan" class="nav_link">
                    ...
                    <span class="navlink">Add Broker</span>
                </a>
            </li>
        </ul>
        <ul class="menu_items">
            ...
            <li class="nav_link submenu_item">
                <a href="/appliedLoans" class="nav_link">
                    ...
                    <span class="navlink"> All User</span>
                </a>
            </li>
            <!-- End -->
            ...
            <li class="nav_link submenu_item">
                <a href="/loanStatus" class="nav_link">
                    ...
                    <span class="navlink">User Status</span>
                </a>
            </li>
            <li class="nav_link submenu_item">
                <a href="/newLoan" class="nav_link">
