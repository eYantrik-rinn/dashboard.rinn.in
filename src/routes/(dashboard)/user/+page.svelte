            ...
            <div class=" mx-auto m-20 p-20 "> 
                ...
                >
                    ...
                    >
                        ...
                        >
                        <h1  class="xl:text-3xl lg:2xl md:xl text-xl">Welcome Home !</h1>
                            <!-- <svg
                                class="w-full h-24"
                        ...
                        <div class="p-12 md:pr-24 md:pl-16 md:py-12">
                            <p class="text-gray-600">
                                <span class="text-gray-900"
                                    >This looks uneven to me</span
                                > Lorem ipsum dolor sit amet consectetur adipisicing elit. Mollitia velit alias perferendis quam adipisci assumenda, iure distinctio aperiam quas, ipsum porro voluptatibus doloremque in quidem necessitatibus quo rem nihil unde?
                            </p>
                            <a
