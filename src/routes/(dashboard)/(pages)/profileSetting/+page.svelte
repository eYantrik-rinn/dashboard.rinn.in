...
<div class="bg-white w-full flex flex-col lg:ml-64 mt-20 gap-5 px-3 md:px-16 lg:px-28 md:flex-row text-[#161931]">
            ...
            <div class="w-full px-6 pb-8 mt-8 sm:max-w-xl sm:rounded-lg m-auto">
                ...
                <div class="grid max-w-2xl mx-auto mt-8">
                    ...
                    <div class="items-center mt-8 sm:mt-14 text-[#202142]">
                        ...
                        <div class="mb-2 sm:mb-6">
                            <label for="mobile"
                                class="block mb-2 text-sm font-medium text-indigo-900 dark:text-white">Mobile No.</label>
