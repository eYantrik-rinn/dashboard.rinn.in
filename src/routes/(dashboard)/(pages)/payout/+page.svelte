...
/>
<div class="w-screen ">
    <div class=" lg:ml-64 mt-20 max-w-screen-3xl px-2">
        <div
            ...
            >
                ...
                <tbody class="lg:border-gray-300">
                    ...
                    <tr class="">
                        ...
                        >
                            <div
                                class="inline-flex items-center rounded-full bg-red-200 py-1 px-2 text-red-500"
                            >
                                Canceled
                            </div>
                        </td>
                    ...
                    <tr class="">
                        ...
                        >
                            <div
                                class="inline-flex items-center rounded-full bg-blue-200 py-1 px-2 text-blue-500"
                            >
                                Pending
                            </div>
                        </td>
