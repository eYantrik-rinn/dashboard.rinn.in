...
<div class="lg:ml-64 mt-20 mx-auto max-w-screen-3xl px-4 py-8 sm:px-8">
    <div class="flex items-center justify-between pb-6">
        <div>
            <h2 class="font-semibold text-gray-700">Loan Status</h2>
            <span class="text-xs text-gray-500">View your Loan Status</span>
        </div>
    ...
    <div class="overflow-y-hidden rounded-lg border">
        <div class="overflow-x-auto">
            <table class="w-full">
                <thead>
                    <tr
                        class="bg-blue-600 text-left text-xs font-semibold capitalize tracking-widest text-white"
                    >
                        <th class="px-5 py-3">ID</th>
                        <th class="px-5 py-3">Full Name</th>
                        <th class="px-5 py-3">Loan Type</th>
                        <th class="px-5 py-3">loan Ammount</th>
                    ...
                    <tbody class="text-gray-500">
                        <tr>
                            ...
                            >
                                <p class="whitespace-no-wrap">034</p>
                            </td>
                            <!-- <td
                                class="border-b border-gray-200 bg-white px-5 py-5 text-sm"
                            >
                                <div class="flex items-center">
                                    <div class="h-10 w-10 flex-shrink-1">
                                        <p>Anshul Singh</p>
