...
<main>
    {#if $page.data.user}
        ...
        <main class="mt-14 lg:ml-64 bg-gray-200">
            <div
                class=" text-white grid grid-cols-1 px-5 py-10 font-[sans-serif]"
            >
                <div
                    class=" bg-blue-400 container p-10 mx-auto flex flex-col md:flex-row justify-between items-center rounded-xl"
                >
                    <div class="md:w-1/2 text-center md:text-left mb-6 md:mb-0">
                        ...
                        <p class="text-base">
                            Upgrade your skills with our premium courses. Enroll
                            now and access exclusive content!
                        </p>
                    </div>
                    <div class="md:w-1/2 flex justify-center">
                        <a
                            href="#"
                            class="bg-indigo-400 text-white font-semibold py-2.5 px-6 rounded hover:bg-blue-800 transition duration-300 ease-in-out"
                        >
                            Enroll Now
                        </a>
                    </div>
